...
const Workshops: React.FC<{}> = (props) => {
    ...
    return (
        <div className={"bg-gradient-to-b from-neutral-800 to-neutral-900 min-h-screen"}>
            <WorkshopsHeader />
            <div className={"max-w-5xl mx-auto my-5 px-5 mt-0"}>
                <h3 className={"text-xl text-orange-500 font-bold"}>What we're doing now 🎯</h3>
            ...
            <div className={"max-w-5xl mx-auto my-5 mt-20 px-5"}>
