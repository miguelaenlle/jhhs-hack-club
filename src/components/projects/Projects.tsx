        ...
        <div>
            ...
            <div className={"bg-gradient-to-b from-slate-800 to-slate-900 min-h-screen px-5 pt-10 md:px-10 xl:py-20 pb-20"}>
                <div className={"flex flex-col align-center max-w-6xl mx-auto gap-5"}>
                    ...
                    />
                    <WorkshopItem
                        link={"https://herseyhacks.notion.site/Workshop-2-Cat-Photo-App-0a72d67b46b64376a49bf11d83e894f7"}
                        title="Workshop #2: Cat Photo App"
                        firstMeetup={5}
                    />
                    <WorkshopItem
                        link={"https://herseyhacks.notion.site/Workshop-3-Caf-Menu-Site-39e21cac4b34406587a3bfb50ec7aeca"}
                        title="Workshop #3: Cafe Menu Site"
                        firstMeetup={6}
                    />
                    <WorkshopItem
                        link={"https://herseyhacks.notion.site/Challenge-Workshop-Meme-Generator-17ca5814d5124dc4b36b895998fbc687"}
                    ...
                    />
                    <WorkshopItem
                        link={"https://herseyhacks.notion.site/Code-Challenge-fdccb11e1b024e02934c736a03863504"}
                    ...
                    <WorkshopItem
                        link={"https://herseyhacks.notion.site/Advanced-Webdev-Track-26426476e6534b249f0f3a36d3a3f221"}
                        title="Advanced Track"
                    />
                    <WorkshopItem
                        link={"https://herseyhacks.notion.site/Hack-Club-Resources-9618bce8ed184f8daac7703f168f57e3"}
