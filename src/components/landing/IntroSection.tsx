...
const IntroSection: React.FC<{}> = (props) => {
  return (
    <div
      className={
        "bg-[url('./img/background.png')] bg-opacity-10 bg-cover object-fill p-5 backdrop-blur-xl z-10 shadow-lg"
      }
    >
      <div>
        ...
        <div className={"py-16 md:py-32"}>
          <h1
            className={
              "text-4xl md:text-6xl font-bold text-white font-Poppins text-center"
            }
          >
            JHHS Hack Club
          </h1>
          ...
          <p
            className={
              "text-md font-bold text-slate-400 font-mono text-center mt-3 md:mt-10"
            }
          >
            Next Meetup: {formatDate} at 3:00PM at Mr. Brown’s Room 158
          </p>
          <div
            className={
          ...
          >
            ...
            >
              <p
                className={
                  "text-md md:text-xl text-white font-Poppins font-bold"
                }
              >
                Join the Discord
              </p>
            ...
            <a
              href={"/projects"}
              className={
                "bg-gradient-to-r from-cyan-500 to-cyan-700 rounded-full p-4 px-7 w-fit hover:cursor-pointer hover:scale-105 transition-all"
              }
            >
              <p
                className={
